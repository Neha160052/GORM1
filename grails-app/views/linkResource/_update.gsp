        ...
        <div class="modal-body">
            <g:form class="form-horizontal" controller="linkResource" action="saveLinkResource">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <g:textField class="form-control" name="url" value="${resource?.url}"></g:textField>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <g:textArea class="form-control" name="discription" value="${resource?.discription}"></g:textArea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-6 col-sm-2">
                        <g:submitButton class="btn btn-primary" name="Update">Update</g:submitButton>
                    </div>
                    <div class="col-sm-2">
